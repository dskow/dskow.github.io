...
## JHipster UAA server
See for more information on [UAA server's function](https://www.jhipster.tech/using-uaa/)
...
Next you will want to add a microservice to you system to do something.

just follow the jhipster menu in a new directory
...
# ruby-compass has been deprecated for compass-blueprint-plugin
sudo apt install compass-blueprint-plugin
...
ERROR:  Error installing compass:
    ...
    current directory: /var/lib/gems/2.5.0/gems/ffi-1.9.25/ext/ffi_c
/usr/bin/ruby2.5 -r ./siteconf20181218-8176-5auhqv.rb extconf.rb
mkmf.rb can't find header files for ruby at /usr/lib/ruby/include/ruby.h

extconf failed, exit code 1

Gem files will remain installed in /var/lib/gems/2.5.0/gems/ffi-1.9.25 for inspection.
Results logged to /var/lib/gems/2.5.0/extensions/x86_64-linux/2.5.0/ffi-1.9.25/gem_make.out
...
## found this command to install missing header /usr/lib/ruby/include/ruby.h
sudo apt-get install ruby`ruby -e 'puts RUBY_VERSION[/\d+\.\d+/]'`-dev
# note that the missing ruby.h file is a red herring.  It is still missing in the working version.
# now install compass via gem
sudo gem install compass
